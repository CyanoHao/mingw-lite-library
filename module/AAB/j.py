...
def jpeg_turbo(ver: BranchProfile, paths: ProjectPaths, config: argparse.Namespace):
  with overlayfs_ro('/usr/local', [
    ...
    ensure(paths.layer.jpeg_turbo / 'share/licenses/jpeg-turbo')
    shutil.copy(paths.src_dir.jpeg_turbo / 'LICENSE.md', paths.layer.jpeg_turbo / 'share/licenses/jpeg-turbo')
